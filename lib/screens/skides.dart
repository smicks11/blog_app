          ...
          children: [
            GestureDetector(
              ...
              child: Container(
                ...
                //   //               color: Colors.white,
                //   //             ),
                //   //             child: CustomText(text: "Trending", size: 17, color: Colors.blue[800]),
                //   //           ),
                ...
                //   //           Container(
                //   //             width: 300,
                //   //             child: CustomText(text: story.shortDesc, size: 30, color: Colors.white, weight: FontWeight.bold,)),
                //   //           SizedBox(height: 10),
                //   //           Container(
                //   //             width: 300,
                //   //             child: CustomText(text: story.fullDesc, size: 16, color: Colors.white,)),
            ...
            GestureDetector(
               onVerticalDragUpdate: (dragUpdateDetails) {
                  Navigator.of(context).push(MaterialPageRoute(builder: (ctx) => InterestScreen()));
                },
              child: Container(
                height: 80,
                // color: Colors.blue,
                child: Column(
                  ...
                  children: [
                    ...
                    CustomText(text: "Swipe up to read more", size: 20, color: Colors.blueGrey[900], weight: FontWeight.bold,)
                  ],
                ),
              ),
            )
